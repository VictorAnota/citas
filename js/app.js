...
class UI {
	...
	imprimirCitas({citas}){/*Para pasar directo al arreglo
							con: deconstruct*/
		...
		citas.forEach( cita => {
			...
			fechaParrafo.innerHTML=`
				<spa class="font-weight-bolder">Fecha: </spa>
				${fecha}
			`;
...
function nuevaCita(e){
	...
	if (editando) {
		...
		formulario.querySelector('button[type="submit"]').textContent="Crearr cita";
